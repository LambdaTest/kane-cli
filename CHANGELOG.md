...
- **Docs** — new [Remote runs on the cloud grid](docs/user-guide/remote-execution.md) guide; the testrun, mobile, test.md, CI/CD, and configuration pages, the agent skill, and the Kiro steering files no longer say `testrun` excludes mobile.
