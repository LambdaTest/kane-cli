...
|--------|-----------|-------------|
| [Visual](./visual.md) | Screenshot (what you see on screen) | Text, labels, prices, counts, colors, visibility checks |
...
- [Visual Assertions](./visual.md) — screenshot-based text and visibility checks
