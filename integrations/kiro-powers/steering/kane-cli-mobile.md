...
Checkpoint support depends on platform and app. Native network operations and Android storage/cookie paths for visible Chrome or debuggable WebViews exist in the implementation. Full desktop DevTools parity, general native DOM support and equivalent iOS support are not established; verify the specific checkpoint and prerequisites on the intended device.
